" Vim syntax file
" Language:	DML
" Maintainer:	Andrey Stepin
" Last Change:	2011 Aug 19
...
" But avoid matching <::.
syn cluster	cParenGroup	contains=cParenError,cIncluded,cSpecial,cCommentSkip,cCommentString,cComment2String,@cCommentGroup,cCommentStartError,cUserCont,cUserLabel,cBitField,cCppOut,cCppOut2,cCppSkip,cFormat,cNumber,cFloat,cNumbersCom
